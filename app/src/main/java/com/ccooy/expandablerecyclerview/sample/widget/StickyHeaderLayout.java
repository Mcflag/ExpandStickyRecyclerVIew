package com.ccooy.expandablerecyclerview.sample.widget;
...
public class StickyHeaderLayout extends FrameLayout {
    ...
    private void updateStickyView(boolean imperative) {
        ...
        if (adapter instanceof GroupedRecyclerViewAdapter) {
            ...
            }else if(tempCurrentPosition > tempGroupPosition){
                mStickyLayout.setTranslationY(-2000.0f);
            }else{
                mStickyLayout.setTranslationY(-0.0f);
            }
        }
    }
